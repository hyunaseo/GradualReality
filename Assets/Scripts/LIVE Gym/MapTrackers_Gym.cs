...
public class MapTrackers_Gym: MonoBehaviour
{
    ...
    void Start()
    {
        ...
        serial_object_Dict.Add("LHR-F70A47CF", "Tumbler");
        serial_object_Dict.Add("LHR-FD7E5D75", "KettleBell");
        serial_object_Dict.Add("LHR-D6811C64", "Bar");
        serial_object_Dict.Add("LHR-4A7CD0ED", "BarBell");
