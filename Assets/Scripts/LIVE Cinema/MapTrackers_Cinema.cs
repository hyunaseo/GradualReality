...
public class MapTrackers_Cinema: MonoBehaviour
{
    ...
    void Start()
    {
        ...
        serial_object_Dict.Add("LHR-F70A47CF", "CokeCan");
        serial_object_Dict.Add("LHR-FD7E5D75", "PopcornContainer");
        serial_object_Dict.Add("LHR-D6811C64", "PopcornContainerCover");
